      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-left">
          <a href="#" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <img src="/assets1/dist/img/user1-128x128.jpg" alt="User Avatar" class="img-size-50 ml-3 img-circle">
          ...
          <a href="#" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <img src="/assets1/dist/img/user8-128x128.jpg" alt="User Avatar" class="img-size-50 img-circle ml-3">
              <div class="media-body">
                <h3 class="dropdown-item-title">
                  پیمان احمدی
          ...
          <a href="#" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <img src="/assets1/dist/img/user3-128x128.jpg" alt="User Avatar" class="img-size-50 img-circle ml-3">
              <div class="media-body">
                <h3 class="dropdown-item-title">
                  سارا وکیلی
                  ...
                  <div class="card-body">
                    ...
                    <div class="direct-chat-messages">
                      ...
                      <div class="direct-chat-msg">
                        ...
                        <!-- /.direct-chat-info -->
                        <img class="direct-chat-img" src="/assets1/dist/img/user1-128x128.jpg" alt="message user image">
                        <!-- /.direct-chat-img -->
                      ...
                      <div class="direct-chat-msg right">
                        ...
                        <!-- /.direct-chat-info -->
                        <img class="direct-chat-img" src="/assets1/dist/img/user3-128x128.jpg" alt="message user image">
                        <!-- /.direct-chat-img -->
                        <div class="direct-chat-text">
                          بهتره اینو باور کنی :)
                        </div>
                    ...
                    <div class="direct-chat-contacts">
                      <ul class="contacts-list">
                        <li>
                          <a href="#">
                            <img class="contacts-list-img" src="/assets1/dist/img/user1-128x128.jpg">
                        ...
                        <li>
                          <a href="#">
                            <img class="contacts-list-img" src="/assets1/dist/img/user7-128x128.jpg">
                        ...
                        <li>
                          <a href="#">
                            <img class="contacts-list-img" src="/assets1/dist/img/user3-128x128.jpg">
                        ...
                        <li>
                          <a href="#">
                            <img class="contacts-list-img" src="/assets1/dist/img/user5-128x128.jpg">
                        ...
                        <li>
                          <a href="#">
                            <img class="contacts-list-img" src="/assets1/dist/img/user6-128x128.jpg">
                        ...
                        <li>
                          <a href="#">
                            <img class="contacts-list-img" src="/assets1/dist/img/user8-128x128.jpg">
                ...
                <ul class="products-list product-list-in-card pl-2 pr-2">
                  <li class="item">
                    <div class="product-img">
                      <img src="/assets1/dist/img/default-150x150.png" alt="Product Image" class="img-size-50">
                    </div>
...
<!-- jVectorMap -->
<script src="/assets1/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
<script src="/assets1/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
<!-- SlimScroll 1.3.0 -->
<script src="/assets1/plugins/slimScroll/jquery.slimscroll.min.js"></script>
<!-- ChartJS 1.0.2 -->
<script src="/assets1/plugins/chartjs-old/Chart.min.js"></script>

<!-- PAGE SCRIPTS -->
<script src="/assets1/dist/js/pages/dashboard2.js"></script>
</body>
</html>
