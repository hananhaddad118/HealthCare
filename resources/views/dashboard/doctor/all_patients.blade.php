    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index3.html" class="brand-link">
                <img src="/assets1/dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
                 ...
                 with font-awesome or any other icon font library -->
                            <li class="nav-item has-treeview menu-open">
                                ...
                                <ul class="nav nav-treeview">
                                    ...
                                    <li class="nav-item">
                                        <a href="{{route('doctor.app')}}" class="nav-link">
                                            <i class="fa fa-circle-o nav-icon"></i>
                                            <p> المرضى </p>
                                        </a>
                                    </li>
                    ...
                    <div class="card-body table-responsive p-0">
                        <table class="table table-hover">
                            <tbody>
                              ...
                              @if(in_array ($user->id , $paients))

                                <tr>
                                    <td><img src="/images/{{$user->image}}" width="60" height="45"></td>
                                    <td>{{$user->name}}
